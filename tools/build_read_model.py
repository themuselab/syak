...
SRC = Path(__file__).parent.parent.parent.parent / "syak" / "data" / "seoul_shops_detailed.json"
...
def reservation_routes(s):
    ...
    if s.get("talktalkUrl"):
        routes.append({"type": "talktalk", "label": "톡톡으로 문의", "value": s["talktalkUrl"]})
